...
def portfolio():
    ...
    for line in file:
        ...
        date_price =  (read_csv(ticker,'2020-10-01', info[6].strip()))
    ...
    stocklist.sort()
    return(dictlist,dowlist,snplist,stocklist)

        
def graphs():
    
    screener,dow,snp,stock = portfolio()
    screener[0][1] = 0
    dow[0][1] = 0
    snp[0][1] = 0
    days = []
    ...
    for pair in stock:
        stock_vals.append(pair[1])
    
    
        

    plt.plot(days,stock_vals,'green',label = 'Portfolio')
    plt.plot(days,dow_vals,'darkred',  label = 'Dow Jones Index')
    #plt.axvline(x='2020-10-21',color = 'k',linestyle = 'dashed', label = 'Sold on 2020-10-21')
    ...
    ticks = [ "2020-10-05","2020-10-12","2020-10-19","2020-10-26","2020-11-02","2020-11-09","2020-11-16","2020-11-23"]
    #ticks = ["2020-11-20","2020-11-23"]
    plt.xticks(ticks)
    plt.ylabel('Percentage Return')
    plt.title('Portfolio Price Return Since Purchase (Percentage)')
